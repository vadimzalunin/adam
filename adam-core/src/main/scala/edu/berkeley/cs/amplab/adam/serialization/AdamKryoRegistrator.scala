...
import edu.berkeley.cs.amplab.adam.avro.{ADAMGenotype, ADAMPileup, ADAMRecord, ADAMFastaNucleotideContig}
...
class AdamKryoRegistrator extends KryoRegistrator {
  override def registerClasses(kryo: Kryo) {
    ...
    kryo.register(classOf[ADAMFastaNucleotideContig], new AvroSerializer[ADAMFastaNucleotideContig]())
